...
?>
<div class="modal modal--right booking-popup" data-popup="7">
    ...
    <div class="booking-popup__wrapper booking-popup-form">
        <h2 class="h4 title-font booking-popup-form__ttl only-desktop">Закажите сертификат<br>на сигары и алкоголь</h2>
        ...
        <form novalidate id="certificates-form" data-type="js-form" data-url="<?= SITE_TEMPLATE_PATH . '/include/ajax/form/add.php' ?>">
            <input type="hidden" data-type="get-field" data-uf="UF_TITLE" value="Заказать сертификат на сигары и алкоголь - <?= $APPLICATION->ShowTitle(false) ?>">
            <input type="hidden" data-type="get-field" data-uf="UF_PAGE" value="Страница - <?= $host; ?><?= $arPath; ?>">
            <input type="hidden" data-type="get-field" data-uf="UF_MAIL_EVENT_TYPE" value="ORDER_CIG_ALCO">
