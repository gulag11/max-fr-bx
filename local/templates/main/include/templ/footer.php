...
<footer class="footer">
    <div class="container">
        <div class="footer__top only-desktop" data-aos="fade-up">
            <?php $APPLICATION->IncludeComponent(
                'bitrix:menu',
                'footer',
                [
                    'ALLOW_MULTI_SELECT' => 'N',
                    'CHILD_MENU_TYPE' => 'left4footer',
                    'DELAY' => 'N',
                    'MAX_LEVEL' => '2',
                    'MENU_CACHE_GET_VARS' => [''],
            ...
            <div class="footer__top-col" itemscope itemtype="http://schema.org/Organization">
                <a class="footer__top-ttl" href="/contact-us/">Контакты</a>
                <?php if ($arOptions['UF_PHONE']) : ?>
                    <a class="footer__top-link" href="tel:<?= $arOptions['UF_PHONE_F']; ?>" data-nolink="" itemprop="telephone"><?= $arOptions['UF_PHONE']; ?></a>
                <?php endif;
                if ($arOptions['UF_EMAIL']) : ?>
                    <a class="footer__top-link" href="mailto:<?= $arOptions['UF_EMAIL']; ?>" data-nolink="" itemprop="email"><?= $arOptions['UF_EMAIL']; ?></a>
                <?php endif;
                if ($arOptions['UF_ADDRESS']) : ?>
                    <div class="footer__top-link" itemprop="address"><?= $arOptions['UF_ADDRESS']; ?></div>
                <?php endif;
                if ($arSocLinks) : ?>
        ...
        <div class="footer__top-mob only-mobile" data-aos="fade-up">
            <div class="footer__contacts" data-aos="fade-up">
                ...
                <?php if ($arOptions['UF_ADDRESS']) : ?>
                    <div class="footer__top-link"><?= $arOptions['UF_ADDRESS']; ?></div>
                <?php endif; ?>
            </div>
            <?php $APPLICATION->ShowViewContent('footer_menu_mob'); ?>
        </div>
        <div class="footer__bottom" data-aos="fade-up">
            <div class="footer__bottom-col">
                <div class="plus18">
                    <img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/18plus.png" alt="" />
                    <div>
                        <?php $APPLICATION->IncludeComponent(
                            'bitrix:main.include',
                            '',
                            [
                                ...
                                'EDIT_TEMPLATE' => '',
                                'PATH' => '/main/include/footer_text_1.php'
                            ]
                        ); ?>
                    </div>
                </div>
            ...
            <div class="footer__bottom-col">
                <div class="footer__bottom-links-col">
                    <a class="footer__bottom-links" href="/p-p/" target="_blank" data-nolink="">Политика обработки персональных данных</a>
                    <a class="footer__bottom-links" href="/delivery/">Доставка и оплата</a>
                </div>
                <div class="footer__corp only-mobile">© FREUD CLUB, 2018−<?= (date('Y')); ?></div>
                <div class="footer__authors-col">
                    <div class="footer__authors only-desktop">Дизайн <span>Mojo</span></div>
                    <div class="footer__authors only-mobile">Дизайн<br /><span>Mojo</span></div>
                    <div class="footer__authors">Разработка и поддержка <a href="https://cloudmill.ru/" target="_blank" data-nolink="">CloudMill</a></div> 
                    <div class="footer__corp only-desktop">© FREUD CLUB, 2018−<?= (date('Y')); ?></div>
                </div>
            </div>
        </div>
    </div>
