                    ...
                    <div class="swiper-slide">
                        <div class="catalog-card<?=$item['BASKET']['CLASS']?>" data-type="item">
                            ...
                            <div class="catalog-card__top">
                                ...
                                <a href="<?= $item['DETAIL_PAGE_URL'] ?>">
                                    <picture>
                                        ...
                                        <img src="<?= $item['IMG'] ?>" alt="<?= $item['NAME'] ?>" data-field-img/>
                                    </picture>
                                </a>
                            </div>
                            <a class="catalog-card__bottom" href="<?= $item['DETAIL_PAGE_URL'] ?>">
                                ...
                                <div class="catalog-card__info">
                                    ...
                                    <div class="catalog-card__price">
                                        <div>
                                            <span class="current"><span data-type="price" data-field="price"><?= (int) $item['PRICE'] ?></span> <?=CURRENCY_FORMAT[$item['CURRENCY']] ?></span>
                                            <?php if ($asd): ?>
                                                <span class="old">165 750 ₽</span>
                                            <?php endif; ?>
                                        </div>
                                        <svg class="added-to-cart only-desktop" width="30" height="26"
                                             viewBox="0 0 30 26"
                            ...
                            <div class="catalog-card__btn-container">
                                <button class="button button--brown catalog-card__btn only-desktop" tabindex="-1"
                                    <?=$item['BASKET']['ATTR']?> data-event="add"
                                        data-id="<?= $item['ID'] ?>"><?=$item['BASKET']['TEXT']['DESKTOP']?>
                                </button>
                                <button class="button button--brown catalog-card__btn only-mobile" tabindex="-1"
                                    <?=$item['BASKET']['ATTR']?> data-event="add"
